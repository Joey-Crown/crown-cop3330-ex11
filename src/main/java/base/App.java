...
public class App 
{
    public static void main( String[] args )
    {
        ...
        // input the amount of euros
        System.out.print("How many euros are you exchanging? ");
        double c_from =  number1.nextDouble();

        // input the exchange rate
        System.out.print("What is the exchange rate? ");
        double exchangeRate =  number2.nextDouble();

        //calculating USD
        double c_to = exchangeRate * c_from;
        c_to = Math.ceil(c_to * 100);
        c_to = c_to / 100;

        // output
        System.out.printf("%.0f euros at an exchange rate of %.4f is %.2f U.S. dollars.", c_from, exchangeRate, c_to);
    }
}
